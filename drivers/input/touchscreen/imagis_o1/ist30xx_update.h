...
#define IST30XXB_REG_WDTCON		IST30XXB_DA_ADDR(0x40003000)
...
#define IST30XXB_REG_PADCTRL		IST30XXB_DA_ADDR(0x40000024)
...
#define IST30XXB_MEM_COUNT		IST30XXB_DA_ADDR(IST30XXB_MEM_ADDR | 0x30)

#if (IMAGIS_TSP_IC == IMAGIS_IST30XXB)
#define IST30XXB_MEM_KEYSENSITIVITY	IST30XXB_DA_ADDR(IST30XXB_MEM_ADDR | 0x5F0)
#elif (IMAGIS_TSP_IC == IMAGIS_IST3038)
#define IST30XXB_MEM_KEYSENSITIVITY	IST30XXB_DA_ADDR(IST30XXB_MEM_ADDR | 0x40)
#else
...
#define IST30XX_FW_VER5			(0x00050000)
...
int ist30xxb_burst_read(struct i2c_client *client,
	u32 addr, u32 *buf32, int len);
